...
function getPropertyValue(style, prop, defa) {
    ...
    if (val == null || val === "") {
        ...
        } else if (browser$2.msie || browser$2.edge) {
...
function renderText(element, node, group) {
    ...
    if (browser$2.msie || browser$2.edge) {
    ...
    if ((browser$2.msie || browser$2.edge) && textOverflow == "ellipsis") {
    ...
    function actuallyGetRangeBoundingRect(range) {
        ...
        if (browser$2.msie || browser$2.edge || browser$2.chrome) {
    ...
    function drawText(str, box) {
        ...
        if ((browser$2.msie || browser$2.edge) && !isNaN(lineHeight)) {
